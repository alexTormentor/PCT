...
'''
прога еще не является неблокирующей. В полностью  неблокирующей прое вычисления и обмен данными перекрывались бы, позволяя программе выполнять обе задачи 
